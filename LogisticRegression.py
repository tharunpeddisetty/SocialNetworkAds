...
classifier = LogisticRegression(random_state=0) #c is the inverse of the regularization strength. smaller c stronger regularization , preventing the model from overfitting
